...
def AddTachoMotorTestsToSuite( suite, driver_name, params ):
...
# echo lego-ev3-m-motor > /sys/class/lego-port/port4/set_device

# Run the full suite of parameterized tests once per motor driver type

if __name__ == '__main__':
#    for k in motor_info:
    for k in ['fi-l12-ev3-50']:
        ...
        AddTachoMotorTestsToSuite( suite, k, params )
